                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #e6eaf2;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:22px;">
                            <h1 style="margin:0 0 10px 0;font-size:22px;line-height:1.3;">E-mail received from :</h1>
                            <p style="margin:0 0 16px 0;color:#374151;">{{ $data['name'] }} , {{ $data['email'] }}</p>

                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin:14px 0 8px 0;">
                                <tr>
                                    <td style="padding:10px 0;color:#6b7280;width:160px;">Phone</td>
                                    <td style="padding:10px 0;font-weight:700;font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;">{{ $data['phone'] ?? 'n/a' }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding:10px 0;">{{ $data['subject'] }}</td>
                                                            ...
                                                            <tr>
                                    <td style="padding:10px 0;color:#6b7280;" colspan="2">
                                        {{ $data['message'] }}
                                    </td>

                                </tr>
                                @if(!empty($data['tour_context']))
                                <tr>
                                    <td style="padding:10px 0;color:#6b7280;" colspan="2">
                                        {{ $data['message'] }}
                                    </td>
