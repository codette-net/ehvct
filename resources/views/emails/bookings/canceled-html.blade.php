                ...
                <tr>
                    <td style="padding:22px;">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin:14px 0 8px 0;">
                            ...
                            @if($isRefunded)
                                <tr>
                                    <td style="padding:10px 0;color:#6b7280;">Refunded at</td>
                                    <td style="padding:10px 0;">
                                        {{ optional($booking->refunded_at)->format('D d M Y, H:i') ?? 'Processed' }}
                                    </td>
                                </tr>
                            @endif
                        </table>
                        ...
                        @if($booking->canceled_reason)
                            ...
                            <h2 style="margin:0 0 8px 0;font-size:16px;">Reason</h2>
                            <p style="margin:0;color:#374151;">{{ $booking->canceled_reason }}</p>
                        @endif
                        ...
                        <p style="margin:18px 0 0 0;">Kind regards,<br><strong>{{ config('app.name') }}</strong></p>
                    </td>
                </tr>
