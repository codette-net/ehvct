...
33 -555 40 -847 51 -1807 66 -620 10 -2783 14 -2791 5z"/>
        ...
        <div class="max-w-3xl w-full text-center">
            <p class="mt-4 text-lg md:text-xl">
                We are getting ready to launch. See you soon.
            </p>
            ...
            <div class="mt-10 flex justify-center">
                <div class="grid grid-flow-col gap-5 text-center auto-cols-max">
                    ...
                    <span class="countdown font-mono text-5xl">
                        <span id="days" style="--value:0;" aria-live="polite" aria-label="days">0</span>
                    </span>
                        days
                    </div>
                    <div class="bg-neutral rounded-box text-neutral-content flex flex-col p-2">
                    <span class="countdown font-mono text-5xl">
                        <span id="hours" style="--value:0;" aria-live="polite" aria-label="hours">0</span>
                    </span>
                        hours
                    </div>
                    <div class="bg-neutral rounded-box text-neutral-content flex flex-col p-2">
                    <span class="countdown font-mono text-5xl">
                        <span id="minutes" style="--value:0;" aria-live="polite" aria-label="minutes">0</span>
                    </span>
                        min
                    </div>
                    <div class="bg-neutral rounded-box text-neutral-content flex flex-col p-2">
                    <span class="countdown font-mono text-5xl">
                        <span id="seconds" style="--value:0;" aria-live="polite" aria-label="seconds">0</span>
                    </span>
                        sec
                    </div>
                </div>
            ...
            <p class="mt-10 opacity-70">
                Follow us on
                <a href="https://www.instagram.com/eindhoven_cycling_tours/" class="link" target="_blank">Instagram</a>
                and
                <a href="https://www.facebook.com/ehvct" class="link" target="_blank">Facebook</a>.
            </p>
        </div>
    </section>
    ...
    <script>
        (() => {
            const launchAt = new Date(@json(config('app.launch_date'))).getTime();
            ...
            function updateCountdown() {
                const now = Date.now();
                let diff = Math.max(0, launchAt - now);
                ...
                setValue(ids.days, days);
                setValue(ids.hours, hours);
                setValue(ids.minutes, minutes);
                setValue(ids.seconds, seconds);
            }
